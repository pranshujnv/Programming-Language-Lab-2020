...
/**
 *
 * Class implementing CalculatorSingleDigit GUI, ButtonHighlighter Threads and all
 * necessary functionality
 */
public class CalculatorSingleDigit extends javax.swing.JFrame implements KeyListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatorSingleDigit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CalculatorSingleDigit newCalculatorSingleDigit = new CalculatorSingleDigit();
                newCalculatorSingleDigit.setVisible(true);
            }
        });
    }
    ...
    /**
     * Creates new form CalculatorSingleDigit
     */
    public CalculatorSingleDigit() {
        ...
        funcButtons[0] = fnplusButton;
        funcButtons[6] = fnansButton;
        funcButtons[4] = fnstopButton;
        funcButtons[5] = fnclearButton;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("1. Press Enter to select number");
        jLabel1.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jLabel2.setText("2. Press Enter to select function");

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel3.setText("3. Press AC to clear or  Z to stop");
        ...
        Jtextfield.setFont(new java.awt.Font("Ubuntu", 0, 24)); // NOI18N
        Jtextfield.setText("");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(stopButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(clearButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculatorSingleDigit().setVisible(true);
            }
        });
    }
