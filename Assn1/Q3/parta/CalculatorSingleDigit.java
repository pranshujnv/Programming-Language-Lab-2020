...
public class CalculatorSingleDigit extends javax.swing.JFrame implements KeyListener {
    ...
    private void getResult() {
        try {
            ...
            String res = postfixEvaluate(toPostfix(iofieldData)).toString();
    ...
    public void keyPressed(KeyEvent e) {
        ...
        //System.out.println("Internal:" + iofieldData);
    }
    ...
    private class ButtonHighlighter extends SwingWorker<Void, Void> {
        ...
        private final Runnable changeColourNum = new Runnable() {
            ...
            public void run() {
                if (currMode == 0) {
                    if (currChange < 0) {
                        numButtons[0].setBackground(Color.blue);
                    } else {
        ...
        private final Runnable changeColourFunc = new Runnable() {
            ...
            public void run() {
                if (currMode == 1) {
                    if (funcChange < 0) {
                        funcButtons[0].setBackground(Color.blue);
                    } else {
